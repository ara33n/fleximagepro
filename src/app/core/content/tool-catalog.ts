...
export const TOOL_CATEGORIES: ToolCatalogCategory[] = [
  ...
  },
  {
    ...
    tools: [
      tool('Merge PDF', 'merge-pdf', 'Combine multiple PDF files into one document.'),
      tool('Split PDF', 'split-pdf', 'Split a PDF into separate files.'),
      tool('Rotate PDF', 'rotate-pdf', 'Rotate selected PDF pages.'),
      tool('Extract Pages', 'extract-pdf-pages', 'Extract selected pages from a PDF.'),
      tool('Rearrange PDF Pages', 'rearrange-pdf-pages', 'Reorder PDF pages visually.'),
      tool('Delete PDF Pages', 'delete-pdf-pages', 'Remove unwanted pages from a PDF.'),
      tool('Add Page Numbers', 'add-page-numbers', 'Add page numbers to PDF documents.'),
      tool('Images to PDF', 'images-to-pdf', 'Combine images into one PDF document.', '/images-to-pdf', true),
      tool('PDF to Images', 'pdf-to-images', 'Export PDF pages as images.'),
      tool('PDF Metadata Viewer', 'pdf-metadata-viewer', 'View PDF title, author, page count, and metadata.'),
    ],
  },
  {
    title: 'Text Tools',
  ...
  },
  {
    ...
    icon: 'bi-code-slash',
    tools: [
      tool('JSON Formatter', 'json-formatter', 'Format JSON for easier reading.'),
      tool('JSON Validator', 'json-validator', 'Validate JSON syntax.'),
      tool('XML Formatter', 'xml-formatter', 'Format XML documents.'),
      tool('XML Validator', 'xml-validator', 'Validate XML syntax.'),
      tool('HTML Formatter', 'html-formatter', 'Format HTML markup.'),
      tool('CSS Formatter', 'css-formatter', 'Format CSS stylesheets.'),
      tool('JavaScript Formatter', 'javascript-formatter', 'Format JavaScript code.'),
      tool('HTML Minifier', 'html-minifier', 'Minify HTML markup.'),
      tool('CSS Minifier', 'css-minifier', 'Minify CSS stylesheets.'),
      tool('JavaScript Minifier', 'javascript-minifier', 'Minify JavaScript code.'),
      tool('SQL Formatter', 'sql-formatter', 'Format SQL queries.'),
      tool('URL Encode', 'url-encode', 'Encode text for URLs.'),
      tool('URL Decode', 'url-decode', 'Decode URL-encoded text.'),
      tool('Base64 Encode', 'base64-encode', 'Encode text as Base64.'),
      tool('Base64 Decode', 'base64-decode', 'Decode Base64 text.'),
      tool('JWT Decoder', 'jwt-decoder', 'Decode JWT headers and payloads.'),
      tool('UUID Generator', 'uuid-generator', 'Generate UUID values.'),
      tool('MD5 Generator', 'md5-generator', 'Generate MD5 hashes.'),
      tool('SHA1 Generator', 'sha1-generator', 'Generate SHA1 hashes.'),
      tool('SHA256 Generator', 'sha256-generator', 'Generate SHA256 hashes.'),
      tool('SHA512 Generator', 'sha512-generator', 'Generate SHA512 hashes.'),
    ],
  },
  {
    ...
    icon: 'bi-calculator',
    tools: [
      tool('Age Calculator', 'age-calculator', 'Calculate age from a date of birth.'),
      tool('BMI Calculator', 'bmi-calculator', 'Calculate body mass index.'),
      tool('Percentage Calculator', 'percentage-calculator', 'Calculate percentages quickly.'),
      tool('Discount Calculator', 'discount-calculator', 'Calculate sale discounts.'),
      tool('GST Calculator', 'gst-calculator', 'Calculate GST amounts.'),
      tool('VAT Calculator', 'vat-calculator', 'Calculate VAT amounts.'),
      tool('EMI Calculator', 'emi-calculator', 'Estimate loan EMI payments.'),
      tool('Unit Converter', 'unit-converter', 'Convert common units.'),
      tool('Scientific Calculator', 'scientific-calculator', 'Run scientific calculations.'),
      tool('Binary Calculator', 'binary-calculator', 'Calculate binary values.'),
    ],
  },
  {
    ...
    icon: 'bi-magic',
    tools: [
      tool('QR Code Generator', 'qr-code-generator', 'Generate QR codes.'),
      tool('Barcode Generator', 'barcode-generator', 'Generate barcodes.'),
      tool('Password Generator', 'password-generator', 'Generate strong passwords.'),
      tool('Lorem Ipsum Generator', 'lorem-ipsum-generator', 'Generate placeholder text.'),
      tool('Random Number Generator', 'random-number-generator', 'Generate random numbers.'),
      tool('Random Name Generator', 'random-name-generator', 'Generate random names.'),
      tool('Random Color Generator', 'random-color-generator', 'Generate random colors.'),
      tool('CSS Gradient Generator', 'css-gradient-generator', 'Generate CSS gradients.'),
      tool('CSS Box Shadow Generator', 'css-box-shadow-generator', 'Generate CSS box shadows.'),
      tool('CSS Border Radius Generator', 'css-border-radius-generator', 'Generate border radius CSS.'),
      tool('CSS Clip Path Generator', 'css-clip-path-generator', 'Generate CSS clip-path shapes.'),
    ],
  },
  {
    title: 'GIS / Map Tools',
    icon: 'bi-geo-alt',
    tools: [
      tool('KML Circle Generator', 'kml-circle-generator', 'Generate KML circles for map tools.'),
      tool('KML Polygon Generator', 'kml-polygon-generator', 'Generate KML polygons.'),
      tool('GeoJSON to KML', 'geojson-to-kml', 'Convert GeoJSON data to KML.'),
      tool('KML to GeoJSON', 'kml-to-geojson', 'Convert KML data to GeoJSON.'),
      tool('GPX to KML', 'gpx-to-kml', 'Convert GPX tracks to KML.'),
      tool('Coordinate Converter', 'coordinate-converter', 'Convert coordinate formats.'),
      tool('Latitude & Longitude Finder', 'latitude-longitude-finder', 'Find coordinates for locations.'),
      tool('Distance Calculator', 'distance-calculator', 'Calculate distance between coordinates.'),
      tool('Area Calculator', 'area-calculator', 'Calculate map area.'),
      tool('Buffer Generator', 'buffer-generator', 'Generate map buffers.'),
    ],
  },
  {
    title: 'Color Tools',
    icon: 'bi-palette',
    tools: [
      tool('HEX to RGB', 'hex-to-rgb', 'Convert HEX colors to RGB.'),
      tool('RGB to HEX', 'rgb-to-hex', 'Convert RGB colors to HEX.'),
      tool('HEX to HSL', 'hex-to-hsl', 'Convert HEX colors to HSL.'),
      tool('HSL to HEX', 'hsl-to-hex', 'Convert HSL colors to HEX.'),
      tool('Color Palette Generator', 'color-palette-generator', 'Generate color palettes.'),
      tool('Gradient Generator', 'gradient-generator', 'Create color gradients.'),
      tool('Contrast Checker', 'contrast-checker', 'Check color contrast ratios.'),
      tool('Color Picker', 'color-picker', 'Pick and convert colors.'),
    ],
  },
  {
    ...
    icon: 'bi-clock',
    tools: [
      tool('Timestamp Converter', 'timestamp-converter', 'Convert timestamps into readable dates.'),
      tool('Unix Timestamp Converter', 'unix-timestamp-converter', 'Convert Unix timestamps.'),
      tool('Time Zone Converter', 'time-zone-converter', 'Convert time across time zones.'),
      tool('Date Difference Calculator', 'date-difference-calculator', 'Calculate the difference between dates.'),
      tool('Countdown Timer', 'countdown-timer', 'Create a simple countdown timer.'),
    ],
  },
];
